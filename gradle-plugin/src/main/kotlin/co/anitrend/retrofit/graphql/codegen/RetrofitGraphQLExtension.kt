...
open class RetrofitGraphQLExtension @Inject constructor(objects: ObjectFactory) {
    ...
    /**
     * Returns the default "main" target, creating it if it doesn't exist.
     *
     * @return The main [GraphQLTargetExtension] instance.
     * @throws IllegalStateException If the extension has not been fully initialized.
     */
     ...
     * @param action Configuration action for the target.
     */
    fun target(
        name: String,
