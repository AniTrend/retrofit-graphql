...
/**
 * GraphQLMapper specific mapper, assures that all requests respond with a
 * GraphQL envelope (legacy [co.anitrend.retrofit.graphql.model.body.GraphContainer]
 * or backend-neutral [co.anitrend.retrofit.graphql.model.GraphQLResponse])
