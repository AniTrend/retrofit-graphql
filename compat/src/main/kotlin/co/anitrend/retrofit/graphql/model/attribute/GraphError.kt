 ...
 *
 * **Legacy**: this serializer-coupled error type lives in `:compat` for the
 * deprecated [GraphContainer]/[co.anitrend.retrofit.graphql.converter.GraphConverter]
 * flow. New code should use the backend-neutral
 * [co.anitrend.retrofit.graphql.model.GraphQLResponseError] instead.
 *
 ...
 * @see GraphContainer
 * @see co.anitrend.retrofit.graphql.model.GraphQLResponseError
 */
@Deprecated(
