 ...
 *
 * **Legacy**: Gson-coupled URL parameter builder, part of the deprecated
 * [QueryContainer] flow in `:compat`.
 */
@Deprecated(
    "Legacy Gson-coupled URL parameter builder of the QueryContainer flow. " +
