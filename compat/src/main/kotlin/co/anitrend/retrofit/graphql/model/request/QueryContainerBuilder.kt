 ...
 *
 * **Legacy**: Android `Parcelable`-coupled builder of the deprecated
 * asset-based request flow in `:compat`. New code should use the
 * backend-neutral [co.anitrend.retrofit.graphql.model.request.GraphQLOperationRequest].
 */
@Deprecated(
    "Legacy Parcelable request builder of the asset-based flow. " +
