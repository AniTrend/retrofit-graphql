 ...
 *
 * **Legacy**: this serializer-coupled response wrapper lives in `:compat` for
 * the deprecated [co.anitrend.retrofit.graphql.converter.GraphConverter] flow.
 * New code should use the backend-neutral
 * [co.anitrend.retrofit.graphql.model.GraphQLResponse] contract with
 ...
 * @see GraphError
 * @see GraphQLRequest
 * @see co.anitrend.retrofit.graphql.model.GraphQLResponse
 */
@Deprecated(
